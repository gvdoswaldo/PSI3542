...
const char* mqttUserName = "hivemqesp10773478";  // MQTT username
const char* mqttPwd = "teste123";  // MQTT password
const char* clientID = "gui-doswaldo-10773478"; // client id username+0001
